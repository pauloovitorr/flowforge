...
<div class="relative p-5 border-[1px] border-zinc-200 rounded-xl bg-white shadow-sm flex flex-col justify-between h-44">
    <div class="flex justify-between items-start">
        ...
        <div class="flex gap-1 bg-zinc-50 p-1 rounded-lg border border-zinc-100">
            ...
            <button title="Excluir"
                class="p-1.5 hover:bg-white hover:shadow-sm rounded-md text-zinc-600 hover:text-red-600 transition-all">
